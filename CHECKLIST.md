...
- [ ] TASKS.md — faza vazifalarga bo'lindi
- [ ] Prisma product modellari + migratsiya
- [ ] Products backend moduli (repository → service → controller + testlar)
- [ ] Kategoriyalar daraxti + o'lchov birliklari / o'ram konvertatsiyasi
