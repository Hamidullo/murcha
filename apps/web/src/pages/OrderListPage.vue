...
<template>
  <div>
    <h1 class="text-2xl font-semibold text-brand-brown">Zakazlar</h1>
    ...
    <p v-else-if="isError" class="mt-6 text-sm text-red-600">Zakazlarni yuklab bo'lmadi</p>
    <p v-else-if="orders.length === 0" class="mt-6 text-sm text-brand-brown/60">Zakaz yo'q</p>
      ...
      <table class="w-full text-left text-sm">
        <thead class="border-b border-brand-brown/10 text-brand-brown/60">
          <tr>
            ...
            <th class="px-4 py-3 font-medium">Sotuv nuqtasi</th>
