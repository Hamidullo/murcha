...
<template>
  <div>
    <div class="flex items-center justify-between">
      <h1 class="text-2xl font-semibold text-brand-brown">Sotuv nuqtalari</h1>
      <Button size="sm" @click="router.push({ name: 'sale-point-new' })">Yangi nuqta</Button>
    </div>
      ...
      <table class="w-full text-left text-sm">
        <thead class="border-b border-brand-brown/10 text-brand-brown/60">
          <tr>
            ...
            <th class="px-4 py-3 font-medium">Manzil</th>
